...
<div class="side-panel-shell">    <aside id="side-panel" inert aria-hidden="true"><div class="row panel-title"><h2 id="panel-title">Codex</h2><button id="close-panel" aria-label="Close panel">×</button></div>
    ...
    </aside><div id="panel-resizer" role="separator" tabindex="0" aria-label="Resize side panel" aria-orientation="vertical" aria-valuemin="180" aria-valuemax="560" aria-valuenow="300"></div></div>
...
<dialog id="typography-dialog" aria-labelledby="typography-title"><div class="dialog-heading"><h2 id="typography-title">Typography settings</h2><button type="button" data-close-dialog aria-label="Close typography settings">×</button></div><div class="typography-grid"><label>Font family<select id="type-font"><option value="Georgia">Georgia</option><option value="Palatino Linotype">Palatino</option><option value="Times New Roman">Times New Roman</option><option value="Arial">Arial</option><option value="Verdana">Verdana</option><option value="Courier New">Courier</option></select></label><label>Text size<select id="type-size"><option value="16">Small</option><option value="18">Standard</option><option value="20">Large</option><option value="24">Extra large</option></select></label><label>Line height<select id="type-line"><option value="1.4">1.4</option><option value="1.6">1.6</option><option value="1.8">1.8</option><option value="2">2</option></select></label><label>Text indent<select id="type-indent"><option value="0">None</option><option value="1">1 em</option><option value="1.5">1.5 em</option><option value="2">2 em</option></select></label><label>Paragraph spacing<select id="type-spacing"><option value="0">None</option><option value="0.5">Compact</option><option value="1">Standard</option><option value="1.5">Spacious</option></select></label><label>Page width<select id="type-width"><option value="640">Narrow</option><option value="760">Standard</option><option value="880">Wide</option><option value="1000">Extra wide</option></select></label><label>Text alignment<select id="type-align"><option value="left">Left</option><option value="justify">Justify</option></select></label><label>UI size <output id="type-ui-output">100%</output><input id="type-ui" type="range" min="80" max="130" step="5" value="100"><small>Changes interface sizes only.</small></label></div><button type="button" id="reset-typography">Reset defaults</button></dialog>
@endsection
